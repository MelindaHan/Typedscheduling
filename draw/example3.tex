...
%	\filldraw [fill=gray,draw=black] (8,0) rectangle (9.5,0.7);
	...
	{[fill=tomato,draw=black]
		...
		\node at (0,1) {\textcolor{black}{$\tau_3^1$}};
		\node at (0,0.5) {\textcolor{black}{$73$}};
		
		\filldraw (3,1) circle (0.3cm);
		\node at (3,1) {\textcolor{black}{$\tau_3^3$}};
		\node at (3,0.5) {\textcolor{black}{$5$}};
	...
	{[fill=gold,draw=black]
		...
		\node at (1.5,1) {\textcolor{black}{$\tau_3^2$}};
		\node at (1.5,0.5) {\textcolor{black}{$242$}};
		}
